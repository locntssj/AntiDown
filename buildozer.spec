...
source.dir = .
source.include_exts = py,kv,png,jpg,jpeg,json,txt,md,ini,so
...
android.permissions = INTERNET,READ_EXTERNAL_STORAGE,WRITE_EXTERNAL_STORAGE,POST_NOTIFICATIONS,READ_MEDIA_VIDEO,READ_MEDIA_AUDIO
android.api = 35
android.minapi = 24
android.ndk = 25b
